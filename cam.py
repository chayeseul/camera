...
KEY = 'ddbc1b0ebcde4608a07717c1cef2f473' # 자신의 Cognitive Services API KEY
CF.Key.set(KEY)

BASE_URL = 'https://eastasia.api.cognitive.microsoft.com/face/v1.0' # 자신의 지역에 해당하는 URL
CF.BaseUrl.set(BASE_URL)

img_url = '/home/pi/cam.jpg' # 이미지 파일의 경로
